    ...
    if(props.type == 'landing'){
        ...
        return(          
            <nav className="bg-white border-gray-200 px-2 sm:px-4 py-2.5 rounded dark:bg-gray-800">
                <div className="container flex flex-wrap justify-between items-center mx-auto">
                    <a href="#" className="flex">
                        <img className='class="mr-3' src='/logo white.png' style={{height: '50px'}}></img>
                    </a>
                                ...
                                <li>
                                    {
                                        ...
                                        :
                                            <div>
                                                ...
                                                <div id="tooltip-not-verified" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                            ...
                            <li>
                                {
                                    ...
                                    :
                                        <div>
                                            ...
                                            <div id="tooltip-not-verified-nav" role="tooltip" class="inline-block absolute invisible z-10 py-2 px-3 text-sm font-medium text-white bg-gray-900 rounded-lg shadow-sm opacity-0 transition-opacity duration-300 tooltip dark:bg-gray-700">
                                                Verifique seu email para usar este recurso.
                                                <div class="tooltip-arrow" data-popper-arrow></div>
                                            </div>
                                        </div>

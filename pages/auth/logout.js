	...
	return (
		<div style={{backgroundColor: '#111c2e'}}>
            ...
            <div style={{paddingBottom: '50vh'}} class="p-4 w-full text-center rounded-lg sm:p-8">
				<h3 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Até mais!</h3>
				<p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Aguarde enquanto desconectamos a sua conta. Nos vemos em breve :)</p>
				<div class="mx-auto">

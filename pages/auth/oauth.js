...
export default function Landing() {
    ...
    useEffect(() => {
        ...
        createEmailUser(email, password)
			...
			.catch((e) => {
				const eCodes = {
					'auth/email-already-exists': 'Este email já está em uso, tente outro.',
					'auth/insufficient-permission': 'Erro interno no servidor.',
					'auth/invalid-argument': 'Erro interno no servidor.',
					'auth/invalid-credential': 'Erro interno no servidor.',
					'auth/invalid-display-name': 'Erro interno no servidor.',
					'auth/invalid-email': 'Este email é inválido, tente outro.',
	...
	return (
		<div style={{backgroundColor: '#111c2e'}}>
            ...
            <div style={{paddingBottom: '50vh'}} class="p-4 w-full text-center rounded-lg sm:p-8">
				<h3 class="mb-2 text-3xl font-bold text-gray-900 dark:text-white">Criando a sua conta</h3>
				<p class="mb-5 text-base text-gray-500 sm:text-lg dark:text-gray-400">Aguarde enquanto sua nova conta está sendo criada! :)</p>
				<div class="mx-auto">

...
// O que precisa ter:
// Conta
// [Se o email não for verificado] => Email verification
// - Mudar nome de usuario
// - Mudar foto de perfil
// - Mudar senha (enviar no email)
// Danger Zone
// - Excluir a conta
...
export default function Landing() {
	...
	return (
		...
		<div style={{backgroundColor: '#111c2e'}}>
			...
			<Navbar type='not-home' userName={userData.name} userEmail={userData.email} userAvatar={userData.avatar} userEmailVerified={userData.verified} />
